classdef (Abstract) IvClassifier < ivis.broadcaster.IvListener
    ...
    methods(Access = public)
        ...
        function [mostLikelyGraphicObj, propComplete] = interogate(obj, forcedChoice)
            ...
            % find if any equal-to-or-above threshold (NB: changed to equal
            % to for limiting cases where criterion is Inf and still want
            % to be able to force a particular answer)
        ...
        function [] = forceAnswer(obj, i)
            ...
            if i == 0
                ...
                obj.evidence(i) = obj.criterion(i);
