...
%want to 'manually' interact with the iViewX toolbox
    ...
    properties (Constant)
        ...
        I_VIEW_API_DLL = 'iViewXAPI64' % I_VIEW_API_DLL
    end
    ...
    methods(Access = public)
        ...
        function obj = IvSmi()
            ...
            loadlibrary(obj.I_VIEW_API_DLL, 'iViewXAPI.h');
        ...
        function delete(obj)
            ...
            try
                ...
                calllib(obj.I_VIEW_API_DLL, 'iV_Disconnect');
            catch ME
            ...
            try
                ...
                unloadlibrary(obj.I_VIEW_API_DLL);
            catch ME
...
%             calllib(obj.I_VIEW_API_DLL, 'iV_SetLogger', int32(1), 'iViewXSDK_Matlab_GazeContingent_Demo.txt');

            fprintf('SMI: Connecting to iViewX...\n')
            status = calllib(obj.I_VIEW_API_DLL, 'iV_Connect', '127.0.0.1', int32(4444), '127.0.0.1', int32(5555));
            switch status
                case 1
            ...
            calllib(obj.I_VIEW_API_DLL, 'iV_GetSystemInfo', obj.pSystemInfoData)
            get(obj.pSystemInfoData, 'Value');

% 	disp('Calibrate iViewX')
% 	calllib(obj.I_VIEW_API_DLL, 'iV_SetupCalibration', pCalibrationData)
% 	calllib(obj.I_VIEW_API_DLL, 'iV_Calibrate')
% 
% 
% 	disp('Validate Calibration')
% 	calllib(obj.I_VIEW_API_DLL, 'iV_Validate')
% 
% 
% 	disp('Show Accuracy')
% 	calllib(obj.I_VIEW_API_DLL, 'iV_GetAccuracy', pAccuracyData, int32(0))
...
%             obj.connect();
 ...
 % in future looks like may have to call some kind of callback handle(??)
                if calllib(obj.I_VIEW_API_DLL, 'iV_GetSample', obj.pSampleData)
