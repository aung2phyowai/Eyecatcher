classdef (Sealed) IvTobiiEyeX < ivis.eyetracker.IvDataInput
    ...
    properties (Constant)
        ...
        RAWLOG_NCOLS = 13; % 12 + CPUtime
        RAWLOG_HEADERS = {
            'GazeX_px','GazeY_px','GazeTimestamp','L','R','LeyeX_mm','LeyeY_mm','LeyeZ_mm','ReyeX_mm','ReyeY_mm','ReyeZ_mm','EyePosTimestamp','CPUtime'
            }; % from "myex.c" sourcecode, and/or "myey_v2_1.m"
    end
